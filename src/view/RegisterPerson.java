...
public class RegisterPerson extends JFrame {
	...
	public RegisterPerson() {
		...
		nomePanel.add(Box.createVerticalStrut(5));
		...
		nomeField.setBorder(BorderFactory.createCompoundBorder(new LineBorder(new Color(70, 130, 180), 2, true),
		...
		agePanel.setBackground(new Color(33, 43, 54));
		...
		ageField.setBackground(new Color(33, 43, 54));
		ageField.setCaretColor(Color.WHITE);
		ageField.setBorder(BorderFactory.createCompoundBorder(new LineBorder(new Color(70, 130, 180), 2, true),
				BorderFactory.createEmptyBorder(5, 10, 5, 10)));
